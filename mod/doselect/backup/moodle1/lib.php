 ...
 */
class moodle1_mod_doselect_handler extends moodle1_resource_successor_handler {
    ...
    public function process_legacy_resource(array $data, array $raw = null) {
        ...
        $doselect                       = array();
        $doselect['id']                 = $data['id'];
        $doselect['name']               = $data['name'];
        $doselect['intro']              = $data['intro'];
        $doselect['introformat']        = $data['introformat'];
        ...
        // $page['revision']           = 1;
        $doselect['timemodified']       = $data['timemodified'];
        ...
        $this->fileman = $this->converter->get_file_manager($contextid, 'mod_doselect');

        // convert course files embedded into the intro
        $this->fileman->filearea = 'intro';
        $this->fileman->itemid   = 0;
        $page['intro'] = moodle1_converter::migrate_referenced_files($doselect['intro'], $this->fileman);
        ...
        // write page.xml
        $this->open_xml_writer("activities/doselect_{$moduleid}/doselect.xml");
        $this->xmlwriter->begin_tag('activity', array('id' => $instanceid, 'moduleid' => $moduleid,
            'modulename' => 'doselect', 'contextid' => $contextid));
        $this->write_xml('doselect', $doselect, array('/doselect/id'));
        $this->xmlwriter->end_tag('activity');
        $this->close_xml_writer();

        // write inforef.xml for migrated resource file.
        $this->open_xml_writer("activities/doselect_{$moduleid}/inforef.xml");

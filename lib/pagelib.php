...
class moodle_page {
     ...
     * This is normally used as the main heading at the top of the content.
     *
     * @param string $heading the main heading that should be displayed at the top of the <body> tooltip in ext cert.<Revathi>
    */ 

    public function set_raw_heading($heading) {

...
class completion_info {
    ...
    public function clear_criteria() {
      ...
      //Commented by eAbyas for not removing the course completion
    ...
    public function reset_all_state($cm) {
        ...
        //Commented by eAbyas team for not deleting the course completions.
     ...
     /*   if ($cm->completion == COMPLETION_TRACKING_MANUAL) {
        ...
        */
        ...
        //Commented by eAbyas team for not deleting the course completions for users.
       // $this->delete_all_state($cm);

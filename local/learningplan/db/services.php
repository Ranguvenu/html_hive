...
$functions = array(
    ...
    'local_learningplan_self_unenrol' => array(
        'classname' => 'local_learningplan_external',
        'methodname' => 'self_unenrol',
        'classpath'   => 'local/learningplan/classes/external.php',
        'description' => 'self Un-enrol from Learningplan',
        'ajax' => true,
        'type' => 'read',
    ),
    'local_learningplan_lpath_unenrol_reason' => array(
        'classname' => 'local_learningplan_external',
        'methodname' => 'self_unenrol_reason',
        'classpath'   => 'local/learningplan/classes/external.php',
        'description' => 'self Un-enrol from Learningplan with reason',
        'ajax' => true,
        'type' => 'read',
    )
);

...
$PAGE->set_url('/local/courses/upload/coursecategory_help.php');
...
$PAGE->navbar->add(get_string('upload_course_category', 'local_courses'), new moodle_url('/local/courses/course_category_upload.php'));
...
echo get_string('course_category_help_1', 'local_courses');
echo $OUTPUT->footer();
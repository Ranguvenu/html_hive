...
$PAGE->set_url('/local/courses/completionupload/completion_help.php');
...
$PAGE->navbar->add(get_string('upload_course_completion', 'local_courses'), new moodle_url('/local/courses/course_category_upload.php'));
$PAGE->navbar->add(get_string('manual', 'local_courses'));
echo $OUTPUT->header();
if (isset($CFG->allowframembedding) and ! $CFG->allowframembedding) {
    echo $OUTPUT->box(get_string('coursemanual', 'local_courses'));
}
echo get_string('course_completion_help', 'local_courses');
echo $OUTPUT->footer();
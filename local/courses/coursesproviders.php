...
$PAGE->set_heading(get_string('course_prov', 'local_courses'));
...
$result = $DB->get_records('local_course_providers');

$data = (object)[
    'result' => array_values($result),
];

echo $OUTPUT->render_from_template('local_courses/courseproviders_table', $data);
echo $OUTPUT->footer();

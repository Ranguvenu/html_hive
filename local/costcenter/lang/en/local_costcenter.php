...
$string['adnewcostcenter'] = '<i class="fa fa-sitemap popupstringicon" aria-hidden="true"></i> Add New Organization <div class= "popupstring"></div>';
...
$string['costcenterlicencesettings'] = 'Licence Key';
$string['licencekey'] = 'Licence Key';
$string['licencekey_help'] = 'Licence key need to be validated with the shared key through email after Purchase';
$string['licencekeynotemptymsg'] = 'Licence Key should not be Empty';
$string['invalidlicencekey'] = 'Invalid Licence Key';

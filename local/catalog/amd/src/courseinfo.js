...
define(['jquery', 'core/str', 'core/modal_factory', 'core/modal_events', 'core/fragment', 'core/ajax', 'core/yui'],
    ...
    return {
        ...
        init: function(args) {
            // console.log(args);
            var request = $.ajax({
                    url:  M.cfg.wwwroot + "/local/catalog/courseinfo.php",
                    method: "POST",
       ...
       test: function(args){
         ...
         $.ajax({
             type: "GET",
             url : M.cfg.wwwroot + "/local/catalog/udemyajax.php?action=verifyuserlicense",
                ...
                ModalFactory.create({
                    ...
                    modal.getRoot().on(ModalEvents.save, function(e) {
                        e.preventDefault();
                         $.ajax({
                            type: "GET",
                            url:  M.cfg.wwwroot + "/local/catalog/courseinfo.php?id="+args.courseid+"&enrol="+args.enroll+"",
    ...
    courseratest: function(args){
      $.ajax({
             type: "GET",
             url : M.cfg.wwwroot + "/local/catalog/udemyajax.php?action=courserauserlicense",
             success: function(response) {
            // console.log(response);
             return Str.get_strings([{
                key: 'confirm'
            ...
            {
                key: 'course_self_enrol_license_coursera',
                component: 'local_catalog',
                param: args
            },
            {
    ...
    coursetest: function(args){
        ...
        classroominfo: function(args) {
            ...
            var request = $.ajax({
                    url:  M.cfg.wwwroot + "/local/catalog/classrrominfo.php",
                    method: "POST",
                    data: { crid : args.crid },
                    dataType: "html"
                });
        ...
        programinfo: function(args) {
            ...
            var request = $.ajax({
                    url:  M.cfg.wwwroot + "/local/catalog/classrrominfo.php?programid="+args.programid+"",
                    method: "POST",

...
function xmldb_local_users_install(){
	 ...
	 if ($dbman->table_exists($table)) {
	 	...
	 	$field8 = new xmldb_field('open_position');
	 	$field8->set_attributes(XMLDB_TYPE_CHAR, '255', null, null, null, null);
	 	$dbman->add_field($table, $field8);
	 	...
	 	$field = new xmldb_field('open_gender');
	 	$field->set_attributes(XMLDB_TYPE_CHAR, '50', null, null, null, null);
	 	$dbman->add_field($table, $field);

	 	$field = new xmldb_field('open_ouname');
	 	$field->set_attributes(XMLDB_TYPE_CHAR, '255', null, null, null, null);
	 	$dbman->add_field($table, $field);

	 	$field = new xmldb_field('open_careertrack');
	 	$field->set_attributes(XMLDB_TYPE_CHAR, '255', null, null, null, null);
	 	$dbman->add_field($table, $field);

	 	$field = new xmldb_field('open_dob');
	 	$field->set_attributes(XMLDB_TYPE_INTEGER, '10', null, null, null, null);
	 	$dbman->add_field($table, $field);

	 	$field = new xmldb_field('open_doj');
	 	$field->set_attributes(XMLDB_TYPE_INTEGER, '10', null, null, null, null);
	 	$dbman->add_field($table, $field);

	 	$field = new xmldb_field('open_salutation');
	 	$field->set_attributes(XMLDB_TYPE_CHAR, '50', null, null, null, null);
	 	$dbman->add_field($table, $field);

	 	$field = new xmldb_field('open_functionalreportingto');
	 	$field->set_attributes(XMLDB_TYPE_INTEGER, '10', null, null, null, null);
	 	$dbman->add_field($table, $field);

	 	$field = new xmldb_field('open_costcenter');
	 	$field->set_attributes(XMLDB_TYPE_CHAR, '255', null, null, null, null);
	 	$dbman->add_field($table, $field);

	 	$field = new xmldb_field('open_subdepart');
	 	$field->set_attributes(XMLDB_TYPE_CHAR, '255', null, null, null, null);
	 	$dbman->add_field($table, $field);

	 	$field = new xmldb_field('open_calendar');
	 	$field->set_attributes(XMLDB_TYPE_CHAR, '255', null, null, null, null);
	 	$dbman->add_field($table, $field);
	 }
}

...
class evaluation_courses implements \renderable, \templatable {
    ...
    public function export_for_template(renderer_base $output) {
        ...
        // $inprogress_programs = DashboardEvaluation::inprogress_evaluations($this->filter_text, $this->offset, $this->limit);
        // $completed_programs = DashboardEvaluation::completed_evaluations($this->filter_text, $this->offset, $this->limit);

...
class response_deleted extends \core\event\base {
     ...
     * @return self
     */
    //public static function create_from_record($completed, $evaluation) {
    //    $event = self::create(array(
    //        'relateduserid' => $completed->userid,
    //        'objectid' => $completed->id,
    //        'courseid' => 0,
    //        'context' => \context_system::instance(),
    //        'anonymous' => ($completed->anonymous_response == EVALYUATION_ANONYMOUS_YES),
    //        'other' => array(
    //            'instanceid' => $evaluation->id,
    //            'anonymous' => $completed->anonymous_response) // Deprecated.
    //    ));
    //
    //    $event->add_record_snapshot('local_evaluation_completed', $completed);

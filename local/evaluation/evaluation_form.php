...
class evaluation_form extends moodleform {
    ...
    public function definition() {
        ...
        // $mform->addElement('header', 'general_evaluationhdr', get_string('general_evaluationhdr', 'local_evaluation'));
        ...
        if ($instance == 0) {
            $type = array(null => get_string('select'),
            ...
            if (is_siteadmin($USER->id) || has_capability('local/evaluation:evaluationmode',$context)) {
                ...
                //     $mform->disabledIf('evaluationmode', 'costcenterid', 'neq',1);
                // }
        ...
        $mform->addElement('date_selector', 'timeopen', get_string('evaluationopen', 'local_evaluation'),
            array('optional' => true));

        $mform->addElement('date_selector', 'timeclose', get_string('evaluationclose', 'local_evaluation'),
            array('optional' => true));
        if ($instance !=0) {

...
$string['pluginname'] = 'percipio Course Sync';
$string['cfgformheading'] = 'Global Settings';
$string['enabled'] = 'Enable Plugin';
$string['enabled_help'] = 'Click to enable/disable this plugin';
$string['configerror'] = 'percipio Catalog Sync plugin in not enabled OR has not been configured fully.';
$string['apiurl'] = 'Catalog API URL';
$string['apiurl_help'] = 'The URL to percipio API';
...
$string['taskname'] = "eabyas percipio Course Sync";
...
$string['errorapicall'] = 'percipio API Call failed:"{$a}"';
...
$string['sync_history'] = 'percipio History';
$string['sync_execution'] = 'Run Udemu Course Sync';
$string['synchistory_stats'] = 'percipio History Statistics';
$string['percipiosyncdatetime'] = 'Excuted Date And Time';

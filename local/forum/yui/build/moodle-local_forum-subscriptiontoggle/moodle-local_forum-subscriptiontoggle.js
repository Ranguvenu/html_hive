YUI.add('moodle-local_forum-subscriptiontoggle', function (Y, NAME) {
 ...
 * @main       moodle-local_forum-subscriptiontoggle
 */

/**
 * @namespace M.local_forum
...
var LOGNAME = 'moodle-local_forum-subscriptiontoggle';
...
Y.extend(SubscriptionToggle, Y.Base, {
    ...
    ATTRS: {
         ...
         */
        uri: {
            value: M.cfg.wwwroot + '/local/forum/subscribe_ajax.php'
        }
    }
});

var NS = Y.namespace('M.local_forum.subscriptiontoggle');

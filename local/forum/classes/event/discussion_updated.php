...
/**
 * The local_forum discussion updated event.
 *
 * @package    local_forum
...
/**
 * The local_forum discussion updated event class.
 *
...
class discussion_updated extends \core\event\base {
    ...
    public function get_description() {
        ...
        return get_string("strdiscussionupdated",'local_forum',$stringHelper);
    }
    ...
    public static function get_name() {
        return get_string('eventdiscussionupdated', 'local_forum');
    }

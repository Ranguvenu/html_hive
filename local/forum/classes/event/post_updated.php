...
/**
 * The local_forum post updated event.
 *
 * @package    local_forum
...
/**
 * The local_forum post updated event class.
 *
...
class post_updated extends \core\event\base {
    ...
    public function get_description() {
        ...
        return get_string("strpostupdated",'local_forum',$stringHelper);
    }
    ...
    public static function get_name() {
        return get_string('eventpostupdated', 'local_forum');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->objectid, 'local_forum', 'update post', $logurl, $this->objectid, $this->contextinstanceid);
    }

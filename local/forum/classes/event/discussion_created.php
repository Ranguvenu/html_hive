...
/**
 * The local_forum discussion created event.
 *
 * @package    local_forum
...
/**
 * The local_forum discussion created event class.
 *
...
class discussion_created extends \core\event\base {
    ...
    public function get_description() {
        ...
        return get_string("strdiscussioncreated",'local_forum',$stringHelper);
    }
    ...
    public static function get_name() {
        return get_string('eventdiscussioncreated', 'local_forum');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->contextinstanceid, 'forum', 'add discussion', $logurl, $this->objectid, $this->contextinstanceid);
    }

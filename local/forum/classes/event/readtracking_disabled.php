...
/**
 * The local_forum subscription created event.
 *
 * @package    local_forum
...
/**
 * The local_forum subscription created event class.
 *
...
class readtracking_disabled extends \core\event\base {
    ...
    public function get_description() {
        ...
        return get_string("strreadtrackingdisabled",'local_forum',$stringHelper);
    }
    ...
    public static function get_name() {
        return get_string('eventreadtrackingdisabled', 'local_forum');
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->other['forumid'], 'forum', 'stop tracking', 'view.php?f=' . $this->other['forumid'],

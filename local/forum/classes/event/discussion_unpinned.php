...
/**
 * The local_forum discussion unpinned event.
 *
 * @package    local_forum
...
class discussion_unpinned extends \core\event\base {
    ...
    public function get_description() {
        ...
        return get_string("strdiscussionunpinned",'local_forum',$stringHelper);
    }
    ...
    public static function get_name() {
        return get_string('eventdiscussionunpinned', 'local_forum');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->objectid, 'forum', 'unpin discussion', $logurl, $this->objectid, $this->contextinstanceid);
    }

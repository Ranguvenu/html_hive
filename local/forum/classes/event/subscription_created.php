...
class subscription_created extends \core\event\base {
    ...
    public function get_description() {
        ...
        return get_string("strsubcriptioncreated",'local_forum',$stringHelper);
    }
    ...
    public static function get_name() {
        return get_string('eventsubscriptioncreated', 'local_forum');
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->other['forumid'], 'forum', 'subscribe', 'view.php?f=' . $this->other['forumid'],

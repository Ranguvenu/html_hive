...
$string['addanewdiscussion'] = 'Add a Topic';
...
$string['blockafter_help'] = 'This setting specifies the maximum number of posts which a user can post in the given time period. Users with the capability local/forum:postwithoutthrottling are exempt from post limits.';
$string['blockperiod'] = 'Time period for blocking';
$string['blockperiod_help'] = 'Students can be blocked from posting more than a given number of posts in a given time period. Users with the capability local/forum:postwithoutthrottling are exempt from post limits.';
...
$string['deleteforum'] = 'Are you sure you want to delete this forum?';
...
$string['edit'] = 'Edit';
$string['editforum'] = 'Update forum';
$string['editedby'] = 'Edited by {$a->name} - original submission {$a->date}';
$string['editedpostupdated'] = '{$a}\'s post was updated';
$string['editing'] = 'Editing';
$string['forumviewed'] = 'Local forum viewed';
$string['eventforumcreated'] = 'Local forum created';
$string['eventforumupdated'] = 'Local forum updated';
$string['eventforumdeleted'] = 'Local forum deleted';
...
$string['modulename_link'] = 'local/forum/view';
...
$string['nowallsubscribed'] = 'You are subscribed to all forums.';//in {$a}
$string['nowallunsubscribed'] = 'You are unsubscribed from all forums.'; //in {$a}
...
$string['noforums'] = 'No forums available';
...
$string['no'] = 'Subscribe';
$string['yes'] = 'Unsubscribe';
$string['discussion_forum'] = 'Discussion Forum';
$string['manageforum'] = 'Manage Forums';
...
$string['manage_br_forum'] = 'Manage <br/> forums';
$string['tagarea_forum'] = 'Forums';
$string['forumnamee'] = 'Missing Forum name';



// strings are added by Naresh

//events
$string['user_viewed_forum'] = 'The user {$a->userid} has viewed the forum {$a->objectid}';

$string['strdiscussioncreated'] = 'The user with id {$a->userid} has created the discussion with id {$a->objectid} in the forum with course module id {$a->contextinstanceid} ';

$string['strdiscussiondeleted'] = 'The user with id {$a->userid} has deleted the discussion with id {$a->objectid} in the forum with course module id {$a->contextinstanceid} ';

$string['strdiscussionupdated'] = 'The user with id {$a->userid} has updated the discussion with id {$a->objectid} in the forum with course module id {$a->contextinstanceid} ';

$string['strdiscussionviewed'] = 'The user with id {$a->userid} has viewed the discussion with id {$a->objectid} in the forum with course module id {$a->contextinstanceid} ';

$string['strforumcreated'] = 'The user with id $a->userid has created the forum with id $a->objectid';
$string['strforumdeleted'] = 'The user with id $a->userid has deleted the forum with id $a->objectid';
$string['strpostcreated'] = 'The user with id $a->userid has created the post with id $a->objectid in the discussion with id $a->discussionid in the forum with course module id $a->contextinstanceid';
$string['strpostdeleted'] = 'The user with id $a->userid has deleted the post with id $a->objectid in the discussion with id $a->discussionid in the forum with course module id $a->contextinstanceid';
$string['strpostupdated'] = 'The user with id $a->userid has updated the post with id $a->objectid in the discussion with id $a->discussionid in the forum with course module id $a->contextinstanceid';

$string['strreadtrackingdisabled'] = 'The user with id $a->userid has enabled read tracking for the user with id $a->relateduserid in the forum with course module id $a->contextinstanceid ';

$string['strreadtrackingenabled'] = 'The user with id $a->userid has disabled read tracking for the user with id $a->relateduserid in the forum with course module id $a->contextinstanceid ';

$string['strsubcriptioncreated'] = 'The user with id $a->userid has created the subscribers list for the forum with course module id $a->contextinstanceid ';

$string['strsubcriptiondeleted'] = 'The user with id $a->userid has deleted the subscribers list for the forum with course module id $a->contextinstanceid ';

$string['strsubcribersviewed'] = 'The user with id $a->userid has viewed the subscribers list for the forum with course module id $a->contextinstanceid ';

$string['strdiscussioncreated'] = 'The user with id {$a->userid} has created the discussion with id {$a->objectid} in the forum with course module id {$a->contextinstanceid} ';

$string['strdiscussionmoved'] = 'The user with id {$a->userid} has moved the discussion with id {$a->objectid} in the forum with course module id {$a->contextinstanceid} ';

$string['strdiscussionpinned'] = 'The user {$a->userid} has pinned the discussion {$a->objectid} in the forum {$a->forumid}';
$string['strdiscussionunpinned'] = 'The user {$a->userid} has unpinned the discussion {$a->objectid} in the forum {$a->forumid}';

$string['strdiscussionsubscriptioncreated'] = 'The user with id $a->userid subscribed the user with id $a->relateduserid to the discussion with id $a->discussion in the forum with the course module id $a->contextinstanceid';
$string['strdiscussionsubscriptiondeleted'] = 'The user with id $a->userid unsubscribed the user with id $a->relateduserid from the discussion  with id $a->discussion in the forum with the course module id $a->contextinstanceid';

// strings added by naresh for templates 
//topiclist
$string['topiclistmore'] = 'More...';
$string['topiclistpostedon'] = 'Posted on';
$string['topiclistpostedby'] = 'Posted by';
$string['topiclistlastposton'] = 'Lastpost On';
$string['topiclistlastpostby'] = 'Lastpost By';
$string['topiclistreplies'] = 'Replies';
$string['topicliststartedby'] = 'Started by';
//forumslist
$string['forumslisttopics'] = 'Topics';
$string['forumslistpostedby'] = 'Posted by';

...
$PAGE->requires->js('/blocks/user_bookmarks/js/javascript_file.js',true);
...
$renderer = $PAGE->get_renderer('local_search');
/* foreach($plugininfo AS $plugindata){ print_R($plugindata);die;
} */
                    ...
                    "<div class='w-100 pull-left course_view_list_container'>
                        <div class='col-12 pull-left pl-15'>
                            ...
                            <div ng-if=\"numberofrecords > 0\" class=' clearfix row'>
                                <div dir-paginate='record in courseinfo | itemsPerPage: 15' total-items=numberofrecords class='col-12  catcourses_list active'>

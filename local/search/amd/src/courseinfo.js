...
define(['jquery', 'core/str', 'core/modal_factory', 'core/modal_events', 'core/fragment', 'core/ajax', 'core/yui'],
    ...
    courseratest: function(args){
         ...
         $.ajax({
             type: "GET",
             url : M.cfg.wwwroot + "/local/search/udemyajax.php?action=courserauserlicense&programcode="+args.programcode+"",
             success: function(response) {
             console.log(response);
             return Str.get_strings([{
                key: 'confirm'
   ...
   classroominfo: function(args) {
        ...
        courseratestprogram: function(args) {
            var request = $.ajax({
                    url:  M.cfg.wwwroot + "/local/search/classrrominfo.php",
                    method: "POST",
                    data: { ccourseid : args.courseid },
                    dataType: "html"
                });
                 
                request.done(function( returndata ) {
                    ModalFactory.create({
                            title: Str.get_string('courseraprograms', 'local_search'),
                            body: returndata
                        }).done(function(modal) {
                        // Do what you want with your new modal.
                        modal.show();

...
//             $dataobj->certification_startdate = date('d-m-Y',$data->startdate);
//             $dataobj->certification_enddate = date('d-m-Y',$data->enddate);
...
//             $dataobj->certification_enroluserfulname = $adduser->firstname;
...
//             $dataobj->certification_enroluserfulname = $add_user->firstname;

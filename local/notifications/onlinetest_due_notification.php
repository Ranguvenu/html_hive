...
// 				$dataobj->test_schedule = 'Scheduled From:'.date('d-m-Y',$data->timeopen).' Scheduled To: '.date('d-m-Y',$data->timeclose);
// 			}else{
// 				$dataobj->test_schedule = 'Open Test';
// 			}
// 			$dataobj->test_enroldate = date('d-m-Y',$data->timemodified);
// 			$adduser = $DB->get_record('user',array('id'=>$singleuser));
// 			$dataobj->test_username = $adduser->firstname;

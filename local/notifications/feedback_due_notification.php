...
// 		            $dataobj->feedback_schedule = 'Scheduled From:'.date('d-m-Y',$data->timeopen).' Scheduled To: '.date('d-m-Y',$data->timeclose);
// 		        }else{
// 		            $dataobj->feedback_schedule = 'Open evalaution';
// 		        }
// 		        $dataobj->feedback_enroldate = date('d-m-Y',$data->timemodified);
// 		        $adduser = $DB->get_record('user',array('id'=>$singleuser));
// 		        $dataobj->feedback_username = $adduser->firstname;

 ...
 */
namespace local_udemysync\event;
use local_udemysync\plugin;

defined('MOODLE_INTERNAL') || die();

class sync_complete extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventsynccomplete',plugin::COMPONENT);
    }
    ...
    public function get_description() {
        return get_string('eventsynccompletedesc',plugin::COMPONENT, implode(', ', $this->data['other']));
    }

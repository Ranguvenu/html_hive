...
class sync_error extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventsyncerror',plugin::COMPONENT);
    }
    ...
    public function get_description() {
        return get_string('eventsyncerrordesc',plugin::COMPONENT, $this->data['other']['errormsg']);
    }

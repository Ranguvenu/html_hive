...
class udemysync extends \core\task\scheduled_task {

    /** Label */
    private $learningplansetlabel = 'MS Learn Catalog Courses (Autogenerated DO NOT EDIT)';
    ...
    * @param text $crud - are we testing/developing - called from index.php.
    ...
    public function execute($testing = null,$crud=null) {
        plugin::crud_udemysync($testing,$crud);
    }
}
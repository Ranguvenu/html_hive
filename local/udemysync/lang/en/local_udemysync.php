...
$string['pluginname'] = 'Udemy Course Sync';
$string['cfgformheading'] = 'Global Settings';
$string['enabled'] = 'Enable Plugin';
$string['enabled_help'] = 'Click to enable/disable this plugin';
$string['configerror'] = 'Udemy Catalog Sync plugin in not enabled OR has not been configured fully.';
$string['apiurl'] = 'Catalog API URL';
$string['apiurl_help'] = 'The URL to Udemy API';
...
$string['taskname'] = "eabyas Udemy Course Sync";
...
$string['errorapicall'] = 'Udemy API Call failed:"{$a}"';
...
$string['successcourseupdate'] = 'Course Update Success and marked completed for user: "{$a}"';
$string['successcoursecreate'] = 'Course Creation Success and marked completed for user : "{$a}"';
$string['successcoursecompletion'] = 'Course Mark Completion Success for userID : "{$a}"';
$string['sync_history'] = 'Udemy History';
$string['sync_execution'] = 'Run Udemu Course Sync';
$string['synchistory_stats'] = 'Udemy History Statistics';
$string['udemysyncdatetime'] = 'Excuted Date And Time';

...
//Global options
if(dataStore.getResponse().hide_save == 1)
	var hidesave = true; //true will disable save on your server option
else
	var hidesave = false;
if (dataStore.getResponse().hide_svg_download_on_Android == 1)
	var hidesvg_download_on_Android = true; //true will disable download SVG option on Android devices (not useful)
else
	var hidesvg_download_on_Android = false;
if (dataStore.getResponse().hide_svg_download == 1)
	var hidesvg_download = true; //true will disable download SVG option
else
	var hidesvg_download = false;
if (dataStore.getResponse().hide_png_one_download == 1)
	var hidepng_one_download = true; //true will disable download PNG with first dimensions
else
	var hidepng_one_download = false;
	if (dataStore.getResponse().hide_png_two_download == 1)
	var hidepng_two_download = true; //true will disable download PNG with second dimensions
else
	var hidepng_two_download = false;
	if (dataStore.getResponse().hide_gravatar == 1)
	var hidegravatar = true; //true will disable the possibility to install created avatar as gravatar
else
	var hidegravatar = false;
var path_to_folder = '/local/wavatar/svgavatars/',//the path to main SVG Avatars folder from root dir of your site. The slashes "/" are important!
	...
	hide_save = hidesave, //true will disable save on your server option	
	hide_svg_download_on_Android = hidesvg_download_on_Android, //true will disable download SVG option on Android devices (not useful)
	hide_svg_download = hidesvg_download, //true will disable download SVG option
	hide_png_one_download = hidepng_one_download, //true will disable download PNG with first dimensions
	hide_png_two_download = hidepng_two_download, //true will disable download PNG with second dimensions
	hide_gravatar = hidegravatar, //true will disable the possibility to install created avatar as gravatar

...
class onlinetest_unenrolled extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public function get_description() {
        return "The user with id '$this->userid' unenrolled the user with id '$this->relateduserid' to the online exam of id '$this->objectid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventonlinetestunenrolled', 'local_onlinetests');
    }
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->objectid, 'onlinetests', 'add post', $logurl, $this->objectid, $this->contextinstanceid);
    }

...
class onlinetest_created extends \core\event\base {
    /**
     * Init method.
     *
     * @return void
    ...
    public function get_description() {
        return "The user with id '$this->userid' has created the onlinetest with id '$this->objectid'.";
    }
    ...
    public static function get_name() {
        return get_string('eventonlinetestcreated', 'local_onlinetests');
    }

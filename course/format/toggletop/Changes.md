...
Version 3.2.1.0
  1. Remove old 'format_toggletop_delete_course' function and replace with '\core\event\course_content_deleted' event.
...
Version 3.0.2.1
  ...
  5. Fix 'Managers assigned at Course Category levels cannot change toggletop settings until course exists' - #24.
...
Version 3.0.0.3
  1. Fixed #18, Collapsed Topics Edit menu and MDL-42634-28, ref: https://github.com/gjb2048/moodle-format_toggletop/issues/18
...
11th December 2014 Version 2.8.1.1
  ...
  2. Fix CONTRIB-5472.
  3. Integrated 'Use core required_param for toggle parameters.': https://github.com/gjb2048/moodle-format_toggletop/pull/12
  ...
  4. Improved HTTP protocol handling in 'settoggletoppref.php'.
...
19th August 2014 Version 2.7.1.4
  1. Fixed issue #11: Moodle notice - https://github.com/gjb2048/moodle-format_toggletop/issues/11.
...
20th May 2014 Version 2.7.1 - Stable.
  ...
  2. Fixed CONTRIB-5073 - invisible section causes an error with "toggletop" format.
...
18th December 2013 Version 2.6.1.1
  1. Fixed issue reported by Graham Woodsford whereby teachers could not create Collapsed Topics courses.  This is because the
     ...
     the 'format/toggletop:changelayout', 'format/toggletop:changecolour', 'format/toggletop:changetogglealignment' and
     'format/toggletop:changetoggleiconset' capabilities.  This also implies that the values of the other settings are wrong,
...
24th October 2013 Version 2.5.3.4
  ...
  3. Slight optimisation to 'renderer.php' for getting 'format_toggletop' object when already have it.
...
23rd June 2013 - Version 2.5.2
  ...
  9. Note:  Once you upgrade to this version and beyond then going back will mean loss of the user preferences as you will need to
            remove all 'toggletop_toggle_x' rows from the 'user_preferences' table first.
...
27th April 2013 - Version 2.5.0.2 - Beta
  ...
  2. Fixed an obscure bug with '$defaultuserpreference' in 'format.php' not being parsed to 'M.format_toggletop.init' in 'module.js'.
...
8th February 2013 - Version 2.4.3
  ...
  6. Added capabilities 'format/toggletop:changelayout', 'format/toggletop:changecolour', 'format/toggletop:changetogglealignment'
     and 'format/toggletop:changetoggleiconset' to editing teachers and managers such that site administrators can choose to
...
18th October 2012 - Version 2.3.9.1
  ...
  2. Identified that sometimes when restoring a course, it is accessed for the first time and a toggle is clicked a 'Error
     updating user preference 'toggletop_toggle_x'' (where 'x' is the course id as shown in the URL 'id=x') can occur.  I'm not
...
10th September 2012 - Version 2.3.8.1
  1. Fixed 'Warning: Illegal string offset 'defaultblocks' in ...\toggletop\config.php on line 39' issue when
...
3rd September 2012 - Version 2.3.8
 ...
 10. Cherry picked Luiggi's change
     https://github.com/luiggisanso/moodle-format_toggletop/commit/9bd818f5a4efb347aef4f5154ea2930526552bfc
...
1st August 2012 - Version 2.3.7.2
  ...
  5. Removed 'callback_toggletop_get_section_url' in 'lib.php' because it is no longer required by
     'load_generic_course_sections' in '/lib/navigationlib.php'.
  6. Added 'currentsection' string to '/lang/en/format_toggletop.php' - thanks to [Carlos Kiyan Tsunami](http://moodle.org/mod/forum/discuss.php?d=208066).
...
1st May 2012 - Version 2.3.6 - CONTRIB-3624
  1. Implemented code to facilitate the ability to confirm with the user that it is ok to place the cookie 'mdl_cf_toggletop' on
  ...
  4. A few fixes to changes made in version 2.2.5 where I had renamed table 'format_toggletop_layout' to 'format_toggletop_settings'
     in the code.
...
26th April 2012 - Version 2.3.5 - CONTRIB-3529 - As suggested by [Leonie Vos](http://moodle.org/user/profile.php?id=1435066).
   ...
   5. Renamed 'format_toggletop_layout' table to 'format_toggletop_settings' so that it is a better representation of what it
...
21st March 2012 - Version 2.3.4.2
  1. Received an updated version of 'format_toggletop.php' from Luiggi Sansonetti for the French translation - Merci :).
...
17th March 2012 - Version 2.3.4.1
  ...
  3. Release '2012030100.02' of Moodle 2.3dev converted all tables to have signed integers in the function
     ...
     included 'format_toggletop_layout' because of the code was written.  This made it very difficult for me to create an
     ...
     'format_toggletop_layout' from your database before upgrading.  This is not quite brilliant, but I consider reasonable for
...
14th March 2012 - Version 2.3.4 - BETA - CONTRIB-3520.
  ...
  2. Added the function 'format_toggletop_delete_course' in 'lib.php' which will remove the entry in the 'format_toggletop_layout'
...
1st March 2012 - Version 2.3.3 - Stable
  ...
  2. NOTE: If you have previously installed a Beta or Release Candidate please drop the table 'format_toggletop_layout' before use.
...
NOTE: If uninstallation fails, drop the table 'format_toggletop_layout' and the entry for 'format_toggletop' in the table
...
25th February 2012 - Version 2.3.3 - Release Candidate 1
  ...
  4. If you have previously installed a beta version you will need to drop the table 'format_toggletop_layout' in the database.
  5. If you are a native speaker of a language other than English, I would be grateful of a translation of the new language
     strings in 'lang/en/format_toggletop.php' under the comment 'Layout enhancement - Moodle Tracker CONTRIB-3378'.  Please
...
15th February 2012 - Version 2.3.3 - BETA 7
  1. Added strings for MDL-26105 in format_toggletop.php.
...
12th February 2012 - Version 2.3.3 - BETA 6
  1. Fixed CONTRIB-3283 in lib.js (and hence lib_min.js) for when you are in display only 'Section x' mode and the number of
     ...
     that of a valid one.
  2. Added 'callback_toggletop_get_section_url' in 'lib.php' for MDL-26477.
...
11th February 2012 - Version 2.3.3 - BETA 5
  ...
  2. If you have previously installed this development, you need to drop the table 'format_toggletop_layout' in your database to
...
12th November 2010 - CONTRIB-1471 & CONTRIB-2497 - Changes as a result of MDL-25072:
  ...
  4. Added the string 'toggletoptogglewidth' to the relevant language file and amended format.php so that
...
17th October 2010 - CONTRIB-1471 - Changes as a result of MDL-14679, MDL-20366 and MDL-24316.
  1. Removed the requirement of needing js-override-toggletop.css - to make things simpler.

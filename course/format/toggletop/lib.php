...
class format_toggletop extends core_courseformat\base {
    ...
    public function get_section_name($section) {
        ...
        return $this->get_toggletop_section_name($course, $section, false);
    }
     ...
     * @return string The section name.
     */
    public function get_toggletop_section_name($course, $section, $additional) {
        ...
        if ((string) $thesection->name !== '') {
            ...
            $o = get_string('section0name', 'format_toggletop');
        } else {
            if (($tcsettings['layoutstructure'] == 1) || ($tcsettings['layoutstructure'] == 4)) {
                $o = get_string('sectionname', 'format_toggletop') . ' ' . $thesection->section;
            } else {
                $o .= get_string('topic') . ' ' . $thesection->section;
                //$o .= $this->get_section_dates($section, $course, $tcsettings);
            }
        }
        ...
        if (($additional == true) && ($thesection->section != 0)) {
            switch ($tcsettings['layoutelement']) {
                ...
                case 4:
                    // The word 'Toggle'.
                    //$o .= '<div class="cttoggle"> - ' .get_string('toggletoptoggle', 'format_toggletop') . '</div>';
                    break;
            }
        }
    ...
    public function get_section_dates($section, $course, $tcsettings) {
        ...
        if ($tcsettings['layoutstructure'] == 5) {
            $day = $this->format_toggletop_get_section_day($section, $course);

            $weekday = userdate($day, $dateformat);
            $o = $weekday;
        } else {
            $dates = $this->format_toggletop_get_section_dates($section, $course);
    ...
    public function ajax_section_move() {
        ...
        if ($sections = $modinfo->get_section_info_all()) {
            foreach ($sections as $number => $section) {
                $titles[$number] = $this->get_toggletop_section_name($course, $section, true);
    ...
    public function section_format_options($foreditform = false) {
        ...
        if ($foreditform && !isset($sectionformatoptions['donotshowdate']['label'])) {
            $sectionformatoptionsedit = array(
                'donotshowdate' => array(
                    'label' => new lang_string('donotshowdate', 'format_toggletop'),
                    'help' => 'donotshowdate',
                    'help_component' => 'format_toggletop',
    ...
    public function course_format_options($foreditform = false) {
        ...
        if ($courseformatoptions === false) {
            ...
            $defaulttgfgcolour = get_config('format_toggletop', 'defaulttgfgcolour');
            if ($defaulttgfgcolour[0] == '#') {
                $defaulttgfgcolour = substr($defaulttgfgcolour, 1);
            }
            $defaulttgfghvrcolour = get_config('format_toggletop', 'defaulttgfghvrcolour');
            if ($defaulttgfghvrcolour[0] == '#') {
                $defaulttgfghvrcolour = substr($defaulttgfghvrcolour, 1);
            }
            $defaulttgbgcolour = get_config('format_toggletop', 'defaulttgbgcolour');
            if ($defaulttgbgcolour[0] == '#') {
                $defaulttgbgcolour = substr($defaulttgbgcolour, 1);
            }
            $defaulttgbghvrcolour = get_config('format_toggletop', 'defaulttgbghvrcolour');
            ...
            $courseformatoptions = array(
                ...
                //     'default' => get_config('format_toggletop', 'defaultdisplayinstructions'),
                //     'type' => PARAM_INT,
                // ),
                // 'layoutelement' => array(
                //     'default' => get_config('format_toggletop', 'defaultlayoutelement'),
                //     'type' => PARAM_INT,
                // ),
                // 'layoutstructure' => array(
                //     'default' => get_config('format_toggletop', 'defaultlayoutstructure'),
                //     'type' => PARAM_INT,
                // ),
                // 'layoutcolumns' => array(
                //     'default' => get_config('format_toggletop', 'defaultlayoutcolumns'),
                //     'type' => PARAM_INT,
                // ),
                // 'layoutcolumnorientation' => array(
                //     'default' => get_config('format_toggletop', 'defaultlayoutcolumnorientation'),
                //     'type' => PARAM_INT,
                // ),
                // 'togglealignment' => array(
                //     'default' => get_config('format_toggletop', 'defaulttogglealignment'),
                //     'type' => PARAM_INT,
                // ),
                // 'toggleiconposition' => array(
                //     'default' => get_config('format_toggletop', 'defaulttoggleiconposition'),
                //     'type' => PARAM_INT,
                // ),
                // 'toggleiconset' => array(
                //     'default' => get_config('format_toggletop', 'defaulttoggleiconset'),
                //     'type' => PARAM_ALPHA,
                // ),
                // 'onesection' => array(
                //     'default' => get_config('format_toggletop', 'defaultonesection'),
                //     'type' => PARAM_INT,
                // ),
                // 'toggleallhover' => array(
                //     'default' => get_config('format_toggletop', 'defaulttoggleallhover'),
                //     'type' => PARAM_INT,
                // ),
                ...
                //     'default' => get_config('format_toggletop', 'defaulttgfgopacity'),
                //     'type' => PARAM_RAW,
                // ),
                ...
                //     'default' => get_config('format_toggletop', 'defaulttgbghvropacity'),
                //     'type' => PARAM_RAW,
                // ),
                ...
                //     'default' => get_config('format_toggletop', 'defaulttgbgopacity'),
                //     'type' => PARAM_RAW,
                // ),
                ...
                //     'default' => get_config('format_toggletop', 'defaultshowsectionsummary'),
                //     'type' => PARAM_INT,
                // )
            );
        }
        if ($foreditform && !isset($courseformatoptions['displayinstructions']['label'])) {
            ...
            $courseformatoptionsedit = array(
                ...
                // 'displayinstructions' => array(
                //     'label' => new lang_string('displayinstructions', 'format_toggletop'),
            ...
            //if (has_capability('format/toggletop:changelayout', $context)) {
                // $courseformatoptionsedit['layoutelement'] = array(
                //     'label' => new lang_string('setlayoutelements', 'format_toggletop'),
                ...
                //             1 => new lang_string('setlayout_all', 'format_toggletop'),
                //             // Toggle word and toggle section x.
                //             3 => new lang_string('setlayout_toggle_word_section_x', 'format_toggletop'),
                //             // Toggle word and section number.
                //             2 => new lang_string('setlayout_toggle_word_section_number', 'format_toggletop'),
                //             // Toggle section x and section number.
                //             5 => new lang_string('setlayout_toggle_section_x_section_number', 'format_toggletop'),
                //             // Toggle word.
                //             4 => new lang_string('setlayout_toggle_word', 'format_toggletop'),
                //             // Toggle section x.
                //             8 => new lang_string('setlayout_toggle_section_x', 'format_toggletop'),
                //             // Section number.
                //             6 => new lang_string('setlayout_section_number', 'format_toggletop'),
                //             // No additions.
                //             7 => new lang_string('setlayout_no_additions', 'format_toggletop'))
                //     )
                // );
                // $courseformatoptionsedit['layoutstructure'] = array(
                //     'label' => new lang_string('setlayoutstructure', 'format_toggletop'),
                ...
                //         array(
                //             // Topic.
                //             1 => new lang_string('setlayoutstructuretopic', 'format_toggletop'),
                //             // Week.
                //             2 => new lang_string('setlayoutstructureweek', 'format_toggletop'),
                //             // Current Week First.
                //             3 => new lang_string('setlayoutstructurelatweekfirst', 'format_toggletop'),
                //             // Current Topic First.
                //             4 => new lang_string('setlayoutstructurecurrenttopicfirst', 'format_toggletop'),
                //             // Day.
                //             5 => new lang_string('setlayoutstructureday', 'format_toggletop'))
                //     )
                // );
                // $courseformatoptionsedit['layoutcolumns'] = array(
                //     'label' => new lang_string('setlayoutcolumns', 'format_toggletop'),
                //     'help' => 'setlayoutcolumns',
                //     'help_component' => 'format_toggletop',
                //     'element_type' => 'select',
                //     'element_attributes' => array(
                //         array(1 => new lang_string('one', 'format_toggletop'),   // Default.
                ...
                //     'label' => new lang_string('setlayoutcolumnorientation', 'format_toggletop'),
                //     'help' => 'setlayoutcolumnorientation',
                //     'help_component' => 'format_toggletop',
                //     'element_type' => 'select',
                //     'element_attributes' => array(
                //         array(1 => new lang_string('columnvertical', 'format_toggletop'),
                //               2 => new lang_string('columnhorizontal', 'format_toggletop')) // Default.
                //     )
                // );
                // $courseformatoptionsedit['toggleiconposition'] = array(
                //     'label' => new lang_string('settoggleiconposition', 'format_toggletop'),
                //     'help' => 'settoggleiconposition',
                //     'help_component' => 'format_toggletop',
                //     'element_type' => 'select',
                //     'element_attributes' => array(
                //         array(1 => new lang_string('left', 'format_toggletop'),   // Left.
                //               2 => new lang_string('right', 'format_toggletop'))  // Right.
                //     )
                // );
                // $courseformatoptionsedit['onesection'] = array(
                //     'label' => new lang_string('onesection', 'format_toggletop'),
                //     'help' => 'onesection',
                //     'help_component' => 'format_toggletop',
                //     'element_type' => 'select',
                //     'element_attributes' => array(
                ...
                //     'label' => new lang_string('setshowsectionsummary', 'format_toggletop'),
            ...
            //} else {
                // $courseformatoptionsedit['layoutelement'] = array(
                //     'label' => get_config('format_toggletop', 'defaultlayoutelement'), 'element_type' => 'hidden');
                // $courseformatoptionsedit['layoutstructure'] = array(
                //     'label' => get_config('format_toggletop', 'defaultlayoutstructure'), 'element_type' => 'hidden');
                // $courseformatoptionsedit['layoutcolumns'] = array(
                //     'label' => get_config('format_toggletop', 'defaultlayoutcolumns'), 'element_type' => 'hidden');
                // $courseformatoptionsedit['layoutcolumnorientation'] = array(
                //     'label' => get_config('format_toggletop', 'defaultlayoutcolumnorientation'), 'element_type' => 'hidden');
                // $courseformatoptionsedit['toggleiconposition'] = array(
                //     'label' => get_config('format_toggletop', 'defaulttoggleiconposition'), 'element_type' => 'hidden');
                // $courseformatoptionsedit['onesection'] = array(
                //     'label' => get_config('format_toggletop', 'defaultonesection'), 'element_type' => 'hidden');
                // $courseformatoptionsedit['showsectionsummary'] = array(
                //     'label' => get_config('format_toggletop', 'defaultshowsectionsummary'), 'element_type' => 'hidden');
            //}

            //if (has_capability('format/toggletop:changetogglealignment', $context)) {
                // $courseformatoptionsedit['togglealignment'] = array(
                //     'label' => new lang_string('settogglealignment', 'format_toggletop'),
            ...
            //} else {
                // $courseformatoptionsedit['togglealignment'] = array(
                //     'label' => get_config('format_toggletop', 'defaulttogglealignment'), 'element_type' => 'hidden');
            //}

            //if (has_capability('format/toggletop:changetoggleiconset', $context)) {
                // $courseformatoptionsedit['toggleiconset'] = array(
                //     'label' => new lang_string('settoggleiconset', 'format_toggletop'),
                ...
                //     'label' => new lang_string('settoggleallhover', 'format_toggletop'),
            ...
            //} else {
                // $courseformatoptionsedit['toggleiconset'] = array(
                //     'label' => get_config('format_toggletop', 'defaulttoggleiconset'), 'element_type' => 'hidden');
                // $courseformatoptionsedit['toggleallhover'] = array(
                //     'label' => get_config('format_toggletop', 'defaulttoggleallhover'), 'element_type' => 'hidden');
            //}

            //if (has_capability('format/toggletop:changecolour', $context)) {
                // $opacityvalues = array(
                //     '0.0' => '0.0',
                //     '0.1' => '0.1',
                //     '0.2' => '0.2',
                ...
                //     'label' => new lang_string('settoggleforegroundcolour', 'format_toggletop'),
                ...
                //     'label' => new lang_string('settoggleforegroundopacity', 'format_toggletop'),
                ...
                //     'label' => new lang_string('settoggleforegroundhovercolour', 'format_toggletop'),
                ...
                //     'label' => new lang_string('settoggleforegroundhoveropacity', 'format_toggletop'),
                ...
                //     'label' => new lang_string('settogglebackgroundcolour', 'format_toggletop'),
                ...
                //     'label' => new lang_string('settogglebackgroundopacity', 'format_toggletop'),
                ...
                //     'label' => new lang_string('settogglebackgroundhovercolour', 'format_toggletop'),
                ...
                //     'label' => new lang_string('settogglebackgroundhoveropacity', 'format_toggletop'),
            ...
            //} else {
                ...
                // $courseformatoptionsedit['toggleforegroundopacity'] = array(
                //     'label' => get_config('format_toggletop', 'defaulttgfgopacity'), 'element_type' => 'hidden');
                // $courseformatoptionsedit['toggleforegroundhovercolour'] = array(
                //     'label' => $defaulttgfghvrcolour, 'element_type' => 'hidden');
                // $courseformatoptionsedit['toggleforegroundhoveopacity'] = array(
                //     'label' => get_config('format_toggletop', 'defaulttgfghvropacity'), 'element_type' => 'hidden');
                // $courseformatoptionsedit['togglebackgroundcolour'] = array(
                //     'label' => $defaulttgbgcolour, 'element_type' => 'hidden');
                // $courseformatoptionsedit['togglebackgroundopacity'] = array(
                //     'label' => get_config('format_toggletop', 'defaulttgbgopacity'), 'element_type' => 'hidden');
                // $courseformatoptionsedit['togglebackgroundhovercolour'] = array(
                //     'label' => $defaulttgbghvrcolour, 'element_type' => 'hidden');
                // $courseformatoptionsedit['togglebackgroundhoveopacity'] = array(
                //     'label' => get_config('format_toggletop', 'defaulttgbghvropacity'), 'element_type' => 'hidden');
            //}
            // $readme = new moodle_url('/course/format/toggletop/Readme.md');
            // $readme = html_writer::link($readme, 'Readme.md', array('target' => '_blank'));
            // $courseformatoptionsedit['readme'] = array(
            //         'label' => get_string('readme_title', 'format_toggletop'),
            //         'element_type' => 'static',
            //         'element_attributes' => array(get_string('readme_desc', 'format_toggletop', array('url' => $readme)))
            //     );
    ...
    //     MoodleQuickForm::registerElementType('tccolourpopup', "$CFG->dirroot/course/format/toggletop/js/tc_colourpopup.php",
    ...
    //     $changelayout = has_capability('format/toggletop:changelayout', $context);
    //     $changecolour = has_capability('format/toggletop:changecolour', $context);
    //     $changetogglealignment = has_capability('format/toggletop:changetogglealignment', $context);
    //     $changetoggleiconset = has_capability('format/toggletop:changetoggleiconset', $context);
    //     $resetall = is_siteadmin($USER); // Site admins only.

    //     $elements[] = $mform->addElement('header', 'ctreset', get_string('ctreset', 'format_toggletop'));
    //     $mform->addHelpButton('ctreset', 'ctreset', 'format_toggletop', '', true);

        // $resetelements = array();
        // $checkboxname = get_string('resetdisplayinstructions', 'format_toggletop').
        //     $OUTPUT->help_icon('resetdisplayinstructions', 'format_toggletop');
        // $resetelements[] =& $mform->createElement('checkbox', 'resetdisplayinstructions', '', $checkboxname);

        // if ($changelayout) {
        //     $checkboxname = get_string('resetlayout', 'format_toggletop').$OUTPUT->help_icon('resetlayout', 'format_toggletop');
        //     $resetelements[] =& $mform->createElement('checkbox', 'resetlayout', '', $checkboxname);
        // }

        // if ($changecolour) {
        //     $checkboxname = get_string('resetcolour', 'format_toggletop').$OUTPUT->help_icon('resetcolour', 'format_toggletop');
        //     $resetelements[] =& $mform->createElement('checkbox', 'resetcolour', '', $checkboxname);
        // }

        // if ($changetogglealignment) {
        //     $checkboxname = get_string('resettogglealignment', 'format_toggletop').
        //         $OUTPUT->help_icon('resettogglealignment', 'format_toggletop');
        //     $resetelements[] =& $mform->createElement('checkbox', 'resettogglealignment', '', $checkboxname);
        // }

        // if ($changetoggleiconset) {
        //     $checkboxname = get_string('resettoggleiconset', 'format_toggletop').
        //         $OUTPUT->help_icon('resettoggleiconset', 'format_toggletop');
        //     $resetelements[] =& $mform->createElement('checkbox', 'resettoggleiconset', '', $checkboxname);
        // }
        // $elements[] = $mform->addGroup($resetelements, 'resetgroup', get_string('resetgrp', 'format_toggletop'), null, false);

        // if ($resetall) {
        //     $resetallelements = array();

        //     $checkboxname = get_string('resetalldisplayinstructions', 'format_toggletop').
        //         $OUTPUT->help_icon('resetalldisplayinstructions', 'format_toggletop');
        //     $resetallelements[] =& $mform->createElement('checkbox', 'resetalldisplayinstructions', '', $checkboxname);

        //     $checkboxname = get_string('resetalllayout', 'format_toggletop').
        //         $OUTPUT->help_icon('resetalllayout', 'format_toggletop');
        //     $resetallelements[] =& $mform->createElement('checkbox', 'resetalllayout', '', $checkboxname);

        //     $checkboxname = get_string('resetallcolour', 'format_toggletop').
        //         $OUTPUT->help_icon('resetallcolour', 'format_toggletop');
        //     $resetallelements[] =& $mform->createElement('checkbox', 'resetallcolour', '', $checkboxname);

        //     $checkboxname = get_string('resetalltogglealignment', 'format_toggletop').
        //         $OUTPUT->help_icon('resetalltogglealignment', 'format_toggletop');
        //     $resetallelements[] =& $mform->createElement('checkbox', 'resetalltogglealignment', '', $checkboxname);

        //     $checkboxname = get_string('resetalltoggleiconset', 'format_toggletop').
        //         $OUTPUT->help_icon('resetalltoggleiconset', 'format_toggletop');
        ...
        //         get_string('resetallgrp', 'format_toggletop'), null, false);
    //     }
    ...
    public function edit_form_validation($data, $files, $errors) {
        ...
        //     $retr['toggleforegroundcolour'] = get_string('colourrule', 'format_toggletop');
        // }
        // if ($this->validate_colour($data['toggleforegroundhovercolour']) === false) {
        //     $retr['toggleforegroundhovercolour'] = get_string('colourrule', 'format_toggletop');
        // }
        // if ($this->validate_colour($data['togglebackgroundcolour']) === false) {
        //     $retr['togglebackgroundcolour'] = get_string('colourrule', 'format_toggletop');
        // }
        // if ($this->validate_colour($data['togglebackgroundhovercolour']) === false) {
        //     $retr['togglebackgroundhovercolour'] = get_string('colourrule', 'format_toggletop');
        // }
    ...
    public function update_course_format_options($data, $oldcourse = null) {
        ...
        if (($resetalldisplayinstructions) ||
            ...
            $this->reset_toggletop_setting(0, $resetalldisplayinstructions, $resetalllayout, $resetallcolour,
            ...
            ($resettoggleiconset)) {
            $this->reset_toggletop_setting($this->courseid, $resetdisplayinstructions, $resetlayout, $resetcolour,
    ...
    public function is_section_current($section) {
        ...
        if (($tcsettings['layoutstructure'] == 2) || ($tcsettings['layoutstructure'] == 3)) {
            ...
            $timenow = time();
            $dates = $this->format_toggletop_get_section_dates($section, $this->get_course());
            ...
            $timenow = time();
            $day = $this->format_toggletop_get_section_day($section, $this->get_course());
            $onedayseconds = 86400;
     ...
     */
    private function format_toggletop_get_section_dates($section, $course) {
     ...
     */
    private function format_toggletop_get_section_day($section, $course) {
        $onedayseconds = 86400;
        /* Hack alert. We add 2 hours to avoid possible DST problems. (e.g. we go into daylight
           savings and the date changes. */
        $startdate = $course->startdate + 7200;
     ...
     */
    public function reset_toggletop_setting($courseid, $displayinstructions, $layout, $colour, $togglealignment, $toggleiconset) {
        global $DB, $USER;
        ...
        if ($displayinstructions && $resetallifall) {
            $updatedata['displayinstructions'] = get_config('format_toggletop', 'defaultdisplayinstructions');
            $updatedisplayinstructions = true;
        }
        if ($layout && has_capability('format/toggletop:changelayout', $context) && $resetallifall) {
            $updatedata['layoutelement'] = get_config('format_toggletop', 'defaultlayoutelement');
            $updatedata['layoutstructure'] = get_config('format_toggletop', 'defaultlayoutstructure');
            $updatedata['layoutcolumns'] = get_config('format_toggletop', 'defaultlayoutcolumns');
            $updatedata['layoutcolumnorientation'] = get_config('format_toggletop', 'defaultlayoutcolumnorientation');
            $updatedata['toggleiconposition'] = get_config('format_toggletop', 'defaulttoggleiconposition');
            $updatedata['onesection'] = get_config('format_toggletop', 'defaultonesection');
            $updatedata['showsectionsummary'] = get_config('format_toggletop', 'defaultshowsectionsummary');
            $updatelayout = true;
        }
        if ($togglealignment && has_capability('format/toggletop:changetogglealignment', $context) && $resetallifall) {
            $updatedata['togglealignment'] = get_config('format_toggletop', 'defaulttogglealignment');
            $updatetogglealignment = true;
        }
        if ($colour && has_capability('format/toggletop:changecolour', $context) && $resetallifall) {
            $updatedata['toggleforegroundcolour'] = get_config('format_toggletop', 'defaulttgfgcolour');
            $updatedata['toggleforegroundopacity'] = get_config('format_toggletop', 'defaulttgfgopacity');
            $updatedata['toggleforegroundhovercolour'] = get_config('format_toggletop', 'defaulttgfghvrcolour');
            $updatedata['toggleforegroundhoveropacity'] = get_config('format_toggletop', 'defaulttgfghvropacity');
            $updatedata['togglebackgroundcolour'] = get_config('format_toggletop', 'defaulttgbgcolour');
            $updatedata['togglebackgroundopacity'] = get_config('format_toggletop', 'defaulttgbgopacity');
            $updatedata['togglebackgroundhovercolour'] = get_config('format_toggletop', 'defaulttgbghvrcolour');
            $updatedata['togglebackgroundhoveropacity'] = get_config('format_toggletop', 'defaulttgbghvropacity');
            $updatecolour = true;
        }
        if ($toggleiconset && has_capability('format/toggletop:changetoggleiconset', $context) && $resetallifall) {
            $updatedata['toggleiconset'] = get_config('format_toggletop', 'defaulttoggleiconset');
            $updatedata['toggleallhover'] = get_config('format_toggletop', 'defaulttoggleallhover');
     ...
     * in the old 'format_toggletop_settings' table.
     * @param int $courseid If not 0, then a specific course to reset.
     ...
     */
    public function restore_toggletop_setting($courseid, $layoutelement, $layoutstructure, $layoutcolumns, $tgfgcolour,
        ...
        $lco = get_config('format_toggletop', 'defaultlayoutcolumnorientation');
        if (empty($lco)) {
            ...
            $data['displayinstructions'] = get_config('format_toggletop', 'defaultdisplayinstructions');
            $data['layoutcolumnorientation'] = get_config('format_toggletop', 'defaultlayoutcolumnorientation');
            $data['showsectionsummary'] = get_config('format_toggletop', 'defaultshowsectionsummary');
            $data['togglealignment'] = get_config('format_toggletop', 'defaulttogglealignment');
            $data['toggleallhover'] = get_config('format_toggletop', 'defaulttoggleallhover');
            $data['toggleiconposition'] = get_config('format_toggletop', 'defaulttoggleiconposition');
            $data['toggleiconset'] = get_config('format_toggletop', 'defaulttoggleiconset');
        }
     ...
     */
    public function update_toggletop_columns_setting($layoutcolumns) {
        // Create data array.
...
//comment by revathi
    ...
    public function inplace_editable_render_section_name($section, $linkifneeded = true,
        ...
        if (empty($edithint)) {
            $edithint = new lang_string('editsectionname', 'format_toggletop');
        }
        if (empty($editlabel)) {
            $course = $this->get_course();
            $title = $this->get_toggletop_section_name($course, $section, false);
            $editlabel = new lang_string('newsectionname', 'format_toggletop', $title);
        }
    ...
    public function section_action($section, $action, $sr) {
        ...
        if (($tcsettings['layoutstructure'] == 1) || ($tcsettings['layoutstructure'] == 4)) {
            if ($section->section && ($action === 'setmarker' || $action === 'removemarker')) {
                // Format 'toggletop' allows to set and remove markers in addition to common section actions.
        ...
        $renderer = $PAGE->get_renderer('format_toggletop');
 ...
 * @return \core\output\inplace_editable
 */
function format_toggletop_inplace_editable($itemtype, $itemid, $newvalue) {
    global $CFG;
    ...
    if ($itemtype === 'sectionname' || $itemtype === 'sectionnamenl') {
        ...
        $section = $DB->get_record_sql(
            ...
            array($itemid, 'toggletop'), MUST_EXIST);
 ...
 */
function callback_toggletop_definition() {

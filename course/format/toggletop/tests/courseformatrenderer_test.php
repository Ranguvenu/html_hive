 ...
 */
class format_toggletop_courseformatrenderer_testcase extends advanced_testcase {
    ...
    protected function setUp() {
        ...
        $this->course = $this->getDataGenerator()->create_course(array('format' => 'toggletop', 'numsections' => 1),
    ...
    public function test_start_toggle_section_list() {
        ...
        $theclass = self::call_method($this->outputus, 'start_toggle_section_list',
            array());
        $thevalue = '<ul class="ctopics topics row-fluid" id="accordion">';
    ...
    public function test_display_instructions() {
        ...
        $thevalue = '<li class="tcsection main clearfix" id="toggletop-display-instructions"><div class="left side">';
        ...
        $thevalue .= '<img class="icon spacer" width="1" height="1" alt="" src="';
        $thevalue .= $CFG->wwwroot.'/theme/image.php/_s/clean/core/1/spacer" /></div><div class="content">';
        $thevalue .= '<div class="sectionbody"><p class="toggletop-display-instructions">Instructions: Clicking on the section ';

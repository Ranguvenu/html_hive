 ...
 * @group format_toggletop
 */
class format_toggletop_courseformatlib_testcase extends advanced_testcase {
    ...
    public function test_set_up() {
        ...
        $this->assertEquals('1.0', get_config('format_toggletop', 'defaulttgfgopacity'));
        $this->assertEquals('1.0', get_config('format_toggletop', 'defaulttgfghvropacity'));
        $this->assertEquals('1.0', get_config('format_toggletop', 'defaulttgbgopacity'));
        $this->assertEquals('1.0', get_config('format_toggletop', 'defaulttgbghvropacity'));

        set_config('defaulttgfgopacity', '0.5', 'format_toggletop');
        set_config('defaulttgfghvropacity', '0.6', 'format_toggletop');
        set_config('defaulttgbgopacity', '0.7', 'format_toggletop');
        set_config('defaulttgbghvropacity', '0.8', 'format_toggletop');

        // Check that the defaults now have the new values.
        $this->assertEquals('0.5', get_config('format_toggletop', 'defaulttgfgopacity'));
        $this->assertEquals('0.6', get_config('format_toggletop', 'defaulttgfghvropacity'));
        $this->assertEquals('0.7', get_config('format_toggletop', 'defaulttgbgopacity'));
        $this->assertEquals('0.8', get_config('format_toggletop', 'defaulttgbghvropacity'));

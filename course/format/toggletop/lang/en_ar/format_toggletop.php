...
// Used in format.php.
$string['toggletopsidewidthlang'] = 'en_ar-40px';
...
$string['toggletopopened'] = 'Untie';
$string['toggletopclosed'] = 'Tie';
...
// Capabilities.
$string['toggletop:changelayout'] = 'Change or reset thee layout';
$string['toggletop:changecolour'] = 'Change or reset thee colour';
$string['toggletop:changetogglealignment'] = 'Change or reset thee toggle alignment';
$string['toggletop:changetoggleiconset'] = 'Change or reset thee toggle icon set';

...
$string['nametoggletop'] = 'Toggle Topics';
$string['formattoggletop'] = 'Toggle Topics';

// Used in format.php.
$string['toggletoptoggle'] = 'Toggle';
$string['toggletopsidewidthlang'] = 'en-28px';

// Toggle all - Moodle Tracker CONTRIB-3190.
$string['toggletopall'] = 'sections.';  // Leave as AMOS maintains only the latest translation - so previous versions are still supported.
$string['toggletopopened'] = 'Open all';
$string['toggletopclosed'] = 'Close all';

// Moodle 2.0 Enhancement - Moodle Tracker MDL-15252, MDL-21693 & MDL-22056 - http://docs.moodle.org/en/Development:Languages.
$string['sectionname'] = 'Section';
$string['pluginname'] = 'Toggle Topics';
$string['section0name'] = 'General';

// MDL-26105.
$string['page-course-view-toggletop'] = 'Any course main page in the collapsed topics format';
$string['page-course-view-toggletop-x'] = 'Any course page in the collapsed topics format';
...
// Capabilities.
$string['toggletop:changelayout'] = 'Change or reset the layout';
$string['toggletop:changecolour'] = 'Change or reset the colour';
$string['toggletop:changetogglealignment'] = 'Change or reset the toggle alignment';
$string['toggletop:changetoggleiconset'] = 'Change or reset the toggle icon set';
...
$string['noactivities'] = "No Activities are there";
$string['section_restriction_string'] = "Complete Required Activities to enable Activities Here";

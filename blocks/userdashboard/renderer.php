...
class block_userdashboard_renderer extends plugin_renderer_base {
  ...
  //       $onlinetests_plugin_exist = $core_component::get_plugin_directory('local', 'onlinetests');
		...
		//for remove classroom plugin
		unset($local_pluginlist['classroom']);
		...
		$returndata['class'] = 'userdashboard_menu_link';
		$returndata['iconclass'] = 'fa fa-book';
		$returndata['label'] = get_string('mooc', 'block_userdashboard');
		$returndata['templatename'] = 'local_courses/userdashboard_content';
		$menulinks[$returndata['order'] -1] = $returndata;

...
$PAGE->requires->js('/blocks/learning_plan/js/jquery.dataTables.min.js', true);
$PAGE->requires->js('/blocks/ned_mentor/js/script.js');
...
// code commented by anil-- for remove the drop down
//$studentmenuhtml = '';
//
...
*/
// CENTER.
echo '<h5 align="right">Employee: '.fullname($menteeuser, true).'</a></h5>';
echo '<div id="mentee-course-overview-center" style="width:100% !important;">';
...
if ($enrolledcourses) {
    ...
    foreach ($enrolledcourses as $enrolledcourse) {
        ...
        $row = array();
        $content = '';
        $content .=  '<div class="mentee-course-overview-center_course">';
        ...
        $content .= '<table class="mentee-course-overview-center_table block">';
        $content .= '<tr>';

        $content .= '<td valign="top" class="mentee-grey-border">';
        $content .= '<div class="overview-course coursetitle"><a  href="' . $CFG->wwwroot . '/course/view.php?id=' .
        ...
        //**************** commented by anil -- for do not dislay teachers ************//
        //$content .= '<div class="overview-teacher">';
        //$content .= '<table class="mentee-teacher-table">';
        //// Course teachers.
        ...
        //    $content .= '<tr><td class="mentee-teacher-table-label" valign="top"><span>' .
        ...
        //
        //        $content .= '<div><a onclick="window.open(\'' . $CFG->wwwroot . '/user/profile.php?id=' .
        ...
        //            '/blocks/ned_mentor/pix/email.png"></a></div>';
        ...
        //$content .= '<div class="overview-mentor">';
        //$content .= '<table class="mentee-teacher-table">';
        //if ($mentors = block_ned_mentor_get_mentors($menteeuser->id)) {
        //    $content .= '<tr><td class="mentee-teacher-table-label" valign="top"><span>';
        //    $content .= (get_config('mentor', 'blockname')) ? get_config('mentor', 'blockname') : get_string('mentor',
        //            'block_ned_mentor') . ': ';
        //    $content .= '</span></td><td valign="top">';
        ...
        //            '"><img src="' . $CFG->wwwroot . '/blocks/ned_mentor/pix/email.png"></a></div>';
        //            //'<span class="mentee-lastaccess">' . $lastaccess . '</span></div>';
        //    }
        //    $content .= '</td></tr>';
        //}
        ...
        $content .= '</td>';
        // Progress.
        $content .= '<td valign="top" class="mentee-blue-border">';
        $content .= '<div class="overview-progress blue">'.get_string('progress', 'block_ned_mentor').'</div>';
        $content .= '<div class="vertical-textd">' . $progresshtml . '</div>';
        $content .= '<div algin="right"><a href="'.$CFG->wwwroot.'/blocks/ned_mentor/course_overview_single.php?menteeid='.
            $menteeid.'&courseid='.$enrolledcourse->id.'" style="float:right;">view more...</a></div>';
        $content .= '</td>';
        // Grade.
        $content .= '<td valign="top" class="mentee-blue-border">';
        $content .= '<div class="overview-progress blue">'.get_string('grade', 'block_ned_mentor').'</div>';
        $content .= block_ned_mentor_print_grade_summary($course->id, $menteeuser->id);
        $content .= '</td>';

        $content .= '</tr>';
        $content .= '</table>';

        $content .= '</div>'; // Mentee course overview center course.
        $row[] = $content;
        $data[] = $row;
    }

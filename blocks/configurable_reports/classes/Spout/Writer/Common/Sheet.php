...
namespace block_configurable_reports\Spout\Writer\Common;

use block_configurable_reports\Spout\Common\Helper\StringHelper;
use block_configurable_reports\Spout\Writer\Exception\InvalidSheetNameException;
...
class Sheet
{
    ...
    /** @var \block_configurable_reports\Spout\Common\Helper\StringHelper */
     ...
     * @return Sheet
     * @throws \block_configurable_reports\Spout\Writer\Exception\InvalidSheetNameException If the sheet's name is invalid.
     */

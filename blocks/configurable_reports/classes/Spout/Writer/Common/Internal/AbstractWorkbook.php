...
namespace block_configurable_reports\Spout\Writer\Common\Internal;

use block_configurable_reports\Spout\Writer\Exception\SheetNotFoundException;
 ...
 *
 * @package block_configurable_reports\Spout\Writer\Common
 */
abstract class AbstractWorkbook implements WorkbookInterface
{
    ...
    /**
     * @return \block_configurable_reports\Spout\Writer\Common\Helper\AbstractStyleHelper The specific style helper
     */
     ...
     * The writing will resume where it stopped (i.e. data won't be truncated).
     *
     * @param \block_configurable_reports\Spout\Writer\Common\Sheet $sheet The "external" sheet to set as current
     * @return void
     * @throws \block_configurable_reports\Spout\Writer\Exception\SheetNotFoundException If the given sheet does not exist in the workbook
     */
     ...
     *
     * @param \block_configurable_reports\Spout\Writer\Common\Sheet $sheet
     ...
     * @param \block_configurable_reports\Spout\Writer\Style\Style $style Style to be applied to the row.
     * @return void
     * @throws \block_configurable_reports\Spout\Common\Exception\IOException If trying to create a new sheet and unable to open the sheet for writing
     * @throws \block_configurable_reports\Spout\Writer\Exception\WriterException If unable to write data
     */

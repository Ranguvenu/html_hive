...
namespace block_configurable_reports\Spout\Writer\Common\Helper;

/**
 * Class AbstractStyleHelper
 * This class provides helper functions to manage styles
 *
 * @package block_configurable_reports\Spout\Writer\Common\Helper
 */
abstract class AbstractStyleHelper
{
    ...
    /**
     * @param \block_configurable_reports\Spout\Writer\Style\Style $defaultStyle
     */
     ...
     *
     * @param \block_configurable_reports\Spout\Writer\Style\Style $style The style to be registered
     * @return \block_configurable_reports\Spout\Writer\Style\Style The registered style, updated with an internal ID.
     */
     ...
     *
     * @param \block_configurable_reports\Spout\Writer\Style\Style $style
     * @return bool
     */
     ...
     * @return \block_configurable_reports\Spout\Writer\Style\Style
     */
    ...
    /**
     * @return \block_configurable_reports\Spout\Writer\Style\Style[] List of registered styles
     */
     ...
     *
     * @return \block_configurable_reports\Spout\Writer\Style\Style Default style
     */
     ...
     *
     * @param \block_configurable_reports\Spout\Writer\Style\Style $style The original style
     * @param array $dataRow The row the style will be applied to
     * @return \block_configurable_reports\Spout\Writer\Style\Style The updated style
     */
     ...
     * @param \block_configurable_reports\Spout\Writer\Style\Style $style The original style
     * @param array $dataRow The row the style will be applied to
     * @return \block_configurable_reports\Spout\Writer\Style\Style The eventually updated style
     */

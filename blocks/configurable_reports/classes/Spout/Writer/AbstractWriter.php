...
use block_configurable_reports\Spout\Writer\Exception\WriterAlreadyOpenedException;
use block_configurable_reports\Spout\Writer\Exception\WriterNotOpenedException;
use block_configurable_reports\Spout\Writer\Style\StyleBuilder;
...
abstract class AbstractWriter implements WriterInterface
{
    ...
    /** @var \block_configurable_reports\Spout\Common\Helper\GlobalFunctionsHelper Helper to work with global functions */
     ...
     *
     * @return void
     * @throws \block_configurable_reports\Spout\Common\Exception\IOException If the writer cannot be opened
     */
     ...
     * @return AbstractWriter
     * @throws \block_configurable_reports\Spout\Common\Exception\IOException If the writer cannot be opened or if the given path is not writable
     */
     ...
     *
     * @return void
     * @throws \block_configurable_reports\Spout\Common\Exception\IOException If the pointer is not available
     */
     ...
     * @return void
     * @throws \block_configurable_reports\Spout\Writer\Exception\WriterAlreadyOpenedException If the writer was already opened and must not be.
     */
     ...
     * @api
     * @return AbstractWriter
     * @throws \block_configurable_reports\Spout\Writer\Exception\WriterNotOpenedException If this function is called before opening the writer
     * @throws \block_configurable_reports\Spout\Common\Exception\IOException If unable to write data
     */
     ...
     * @return AbstractWriter
     * @throws \block_configurable_reports\Spout\Common\Exception\InvalidArgumentException If the input param is not valid
     * @throws \block_configurable_reports\Spout\Writer\Exception\WriterNotOpenedException If this function is called before opening the writer
     * @throws \block_configurable_reports\Spout\Common\Exception\IOException If unable to write data
     */

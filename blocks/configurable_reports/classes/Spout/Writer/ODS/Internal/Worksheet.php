...
use block_configurable_reports\Spout\Common\Helper\StringHelper;
...
class Worksheet implements WorksheetInterface
{
    ...
    /** @var \block_configurable_reports\Spout\Common\Escaper\ODS Strings escaper */
    protected $stringsEscaper;

    /** @var \block_configurable_reports\Spout\Common\Helper\StringHelper To help with string manipulation */
    ...
    public function __construct($externalSheet, $worksheetFilesFolder)
    {
        ...
        $this->stringsEscaper = \block_configurable_reports\Spout\Common\Escaper\ODS::getInstance();

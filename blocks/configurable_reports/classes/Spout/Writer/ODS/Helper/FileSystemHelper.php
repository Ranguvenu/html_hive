...
namespace block_configurable_reports\Spout\Writer\ODS\Helper;

use block_configurable_reports\Spout\Writer\Common\Helper\ZipHelper;
use block_configurable_reports\Spout\Writer\ODS\Internal\Worksheet;
 ...
 *
 * @package block_configurable_reports\Spout\Writer\ODS\Helper
 */
class FileSystemHelper extends \block_configurable_reports\Spout\Common\Helper\FileSystemHelper
{
     ...
     *
     * @return FileSystemHelper
     * @throws \block_configurable_reports\Spout\Common\Exception\IOException If unable to create the folder or the "manifest.xml" file
     */

...
use block_configurable_reports\Spout\Writer\Exception\InvalidColorException;

/**
 * Class Color
 * This class provides constants and functions to work with colors
 *
 * @package block_configurable_reports\Spout\Writer\Style
 */
class Color
{
     ...
     * @return void
     * @throws \block_configurable_reports\Spout\Writer\Exception\InvalidColorException
     */

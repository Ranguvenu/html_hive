...
namespace block_configurable_reports\Spout\Writer\XLSX;

use block_configurable_reports\Spout\Writer\AbstractMultiSheetsWriter;
use block_configurable_reports\Spout\Writer\Style\StyleBuilder;
use block_configurable_reports\Spout\Writer\XLSX\Internal\Workbook;

/**
 * Class Writer
 * This class provides base support to write data to XLSX files
 *
 * @package block_configurable_reports\Spout\Writer\XLSX
 */
class Writer extends AbstractMultiSheetsWriter
{
     ...
     * @return Writer
     * @throws \block_configurable_reports\Spout\Writer\Exception\WriterAlreadyOpenedException If the writer was already opened
     */
     ...
     *
     * @return void
     * @throws \block_configurable_reports\Spout\Common\Exception\IOException If unable to open the file for writing
     */
     ...
     * @return void
     * @throws \block_configurable_reports\Spout\Writer\Exception\WriterNotOpenedException If the book is not created yet

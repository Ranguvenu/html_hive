...
use block_configurable_reports\Spout\Writer\Common\Helper\AbstractStyleHelper;
use block_configurable_reports\Spout\Writer\Style\Color;
use block_configurable_reports\Spout\Writer\Style\Style;
...
EOD;
    ...
    protected function getFontsSectionContent()
    {
        ...
        /** @var \block_configurable_reports\Spout\Writer\Style\Style $style */
        ...
        foreach ($this->registeredBorders as $styleId) {
            ...
            foreach ($sortOrder as $partName) {
                if ($border->hasPart($partName)) {
                    /** @var $part \block_configurable_reports\Spout\Writer\Style\BorderPart */

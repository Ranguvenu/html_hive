...
namespace block_configurable_reports\Spout\Writer\XLSX\Helper;

use block_configurable_reports\Spout\Writer\Common\Helper\ZipHelper;
use block_configurable_reports\Spout\Writer\XLSX\Internal\Worksheet;
 ...
 *
 * @package block_configurable_reports\Spout\Writer\XLSX\Helper
 */
class FileSystemHelper extends \block_configurable_reports\Spout\Common\Helper\FileSystemHelper
{
     ...
     * @throws \block_configurable_reports\Spout\Common\Exception\IOException If unable to create the folder
     */
     ...
     *
     * @return FileSystemHelper
     * @throws \block_configurable_reports\Spout\Common\Exception\IOException If unable to create the folder or the ".rels" file
     */
     ...
     *
     * @return FileSystemHelper
     * @throws \block_configurable_reports\Spout\Common\Exception\IOException If unable to create the file
     */
...
EOD;
     ...
     *
     * @return FileSystemHelper
     * @throws \block_configurable_reports\Spout\Common\Exception\IOException If unable to create the folder or one of the files
     */
...
EOD;
     ...
     *
     * @return FileSystemHelper
     * @throws \block_configurable_reports\Spout\Common\Exception\IOException If unable to create at least one of the folders
     */

...
namespace block_configurable_reports\Spout\Reader\XLSX\Helper\SharedStringsCaching;

use block_configurable_reports\Spout\Common\Helper\FileSystemHelper;
use block_configurable_reports\Spout\Common\Helper\GlobalFunctionsHelper;
use block_configurable_reports\Spout\Reader\Exception\SharedStringNotFoundException;
 ...
 *
 * @package block_configurable_reports\Spout\Reader\XLSX\Helper\SharedStringsCaching
 */
class FileBasedStrategy implements CachingStrategyInterface
{
    ...
    /** @var \block_configurable_reports\Spout\Common\Helper\FileSystemHelper Helper to perform file system operations */

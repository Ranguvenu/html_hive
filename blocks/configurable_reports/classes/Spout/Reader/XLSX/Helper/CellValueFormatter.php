...
class CellValueFormatter
{
    ...
    /** @var \block_configurable_reports\Spout\Common\Escaper\XLSX Used to unescape XML data */
    protected $escaper;
    ...
    public function __construct($sharedStringsHelper, $styleHelper, $shouldFormatDates)
    {
        ...
        $this->escaper = \block_configurable_reports\Spout\Common\Escaper\XLSX::getInstance();
    }

...
{
    /** @var \block_configurable_reports\Spout\Reader\XLSX\RowIterator To iterate over sheet's rows */
    ...
    /**
     * @api
     * @return \block_configurable_reports\Spout\Reader\XLSX\RowIterator
     */

...
use block_configurable_reports\Spout\Reader\IteratorInterface;
use block_configurable_reports\Spout\Reader\Wrapper\XMLReader;
use block_configurable_reports\Spout\Reader\XLSX\Helper\CellHelper;
use block_configurable_reports\Spout\Reader\XLSX\Helper\CellValueFormatter;
use block_configurable_reports\Spout\Reader\XLSX\Helper\StyleHelper;
...
class RowIterator implements IteratorInterface
{
    ...
    /** @var \block_configurable_reports\Spout\Reader\Wrapper\XMLReader The XMLReader object that will help read sheet's XML data */
    protected $xmlReader;
     ...
     *
     * @return void
     * @throws \block_configurable_reports\Spout\Common\Exception\IOException If the sheet data XML cannot be read
     */
     ...
     *
     * @return void
     * @throws \block_configurable_reports\Spout\Reader\Exception\SharedStringNotFoundException If a shared string was not found
     * @throws \block_configurable_reports\Spout\Common\Exception\IOException If unable to read the sheet data XML
     */
    ...
    /**
     * @param \block_configurable_reports\Spout\Reader\Wrapper\XMLReader $xmlReader XMLReader object, positioned on a "<c>" tag
     * @return int
     * @throws \block_configurable_reports\Spout\Common\Exception\InvalidArgumentException When the given cell index is invalid
     */

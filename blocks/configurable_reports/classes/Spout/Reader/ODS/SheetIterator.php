...
class SheetIterator implements IteratorInterface
{
    ...
    /** @var \block_configurable_reports\Spout\Common\Escaper\ODS Used to unescape XML data */
    protected $escaper;
    ...
    public function __construct($filePath, $shouldFormatDates)
    {
        ...
        $this->escaper = \block_configurable_reports\Spout\Common\Escaper\ODS::getInstance();
    }
     ...
     *
     * @return void
     * @throws \block_configurable_reports\Spout\Common\Exception\IOException If unable to open the XML file containing sheets' data
     */
     ...
     *
     * @return \block_configurable_reports\Spout\Reader\ODS\Sheet
     */

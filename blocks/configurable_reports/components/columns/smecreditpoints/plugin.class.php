...
class plugin_smecreditpoints extends plugin_base{

	function init(){
		$this->fullname = get_string('smecreditpoints','block_configurable_reports');
		$this->type = 'undefined';
		$this->form = true;
		$this->reporttypes = array('sme_credit_points');
	}

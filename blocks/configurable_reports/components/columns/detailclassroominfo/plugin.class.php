...
class plugin_detailclassroominfo extends plugin_base{

	function init(){
		$this->fullname = get_string('detailclassroominfo','block_configurable_reports');
		$this->type = 'undefined';
		$this->form = true;
		$this->reporttypes = array('detailclassroominfo');
	}
    ...
    // Row -> Complete classroominfo row

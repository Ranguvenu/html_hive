...
class feedbackinfo_form extends moodleform {
    function definition() {
        global $DB, $USER, $CFG;

        $mform =& $this->_form;

        $mform->addElement('header', '', get_string('feedbackinfo','block_configurable_reports'), '');

		$columns = array('feedbackname','department','startdate','enddate','type','employeeid','employeename',

...
class programinfo_form extends moodleform {
    function definition() {
        global $DB, $USER, $CFG;

        $mform =& $this->_form;

        $mform->addElement('header', '', get_string('programinfo','block_configurable_reports'), '');

		$columns = array('programname','shortname','stream','employeeid','employeename',

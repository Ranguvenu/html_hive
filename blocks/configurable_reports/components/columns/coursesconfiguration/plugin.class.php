...
class plugin_coursesconfiguration extends plugin_base{

	function init(){
		$this->fullname = get_string('coursesconfiguration','block_configurable_reports');
		$this->type = 'undefined';
		$this->form = true;
		$this->reporttypes = array('coursesconfiguration');
	}

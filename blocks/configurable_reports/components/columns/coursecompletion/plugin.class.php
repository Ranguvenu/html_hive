...
class plugin_coursecompletion extends plugin_base{

	function init(){
		$this->fullname = get_string('course_completion_field','block_configurable_reports');
		$this->type = 'undefined';
		$this->form = true;
		$this->reporttypes = array('course_completion');
	}

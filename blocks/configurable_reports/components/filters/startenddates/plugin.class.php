 ...
 * @copyright  2020 Anilkumar Cheguri <anil@eabyas.com>
...
class plugin_startenddates extends plugin_base {

    public function init() {
        $this->form = false;
        $this->unique = true;
        $this->fullname = get_string('startendtime', 'block_configurable_reports');
        $this->reporttypes = array('classroom_summary','trainingfeedbackresponses','trainerfeedbackresponses','trainernps');
    }
    ...
    function print_filter(&$mform) {
        ...
        $mform->addElement('date_selector', 'filter_starttime', 'From',array('optional'  => TRUE));
        // $mform->disabledIf('filter_starttime', 'filter_starttime', 'eq', COMPLETION_TRACKING_NONE);
        
        $mform->addElement('date_selector', 'filter_endtime', 'To',array('optional'  => TRUE));

...
class block_learningsummary_completed_external extends external_api{
...
/**
  ...
  public static function get_summary_content_parameters() {
     ...
     * @return array The list of Learning Summary completed and total challenge count.
     */
    public static function get_summary_content($options,$dataoptions,$offset = 0,$limit = 0, $filterdata) {
        ...
        if ($data_object->blocktype == 'completed') {
            $totalcourses=plugin::get_completed_content($stable,$filtervalues,$data_object);
        } 
    ...
    public static function get_summary_content_returns() {
        return new external_single_structure([
            'options' => new external_value(PARAM_RAW, 'The paging data for the service'),
            'dataoptions' => new external_value(PARAM_RAW, 'The data for the service'),
            'totalcount' => new external_value(PARAM_INT, 'total number of completed courses in result set'),
            'filterdata' => new external_value(PARAM_RAW, 'The data for the service'),

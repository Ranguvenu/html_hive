...
if($tabs){
    ...
    echo  $returnoutput = $OUTPUT->render_from_template('block_learningsummary_inprogress/block_learningsummary_inprogress', $cardparams);
}
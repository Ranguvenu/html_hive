...
$string['new_slide_video'] = 'Upload new Slide Video';
...
$string['slide_video'] = 'Slide Video';
$string['video'] = 'Video';
$string['image'] = 'Image';
$string['url'] = 'URL';
$string['upload_type'] = 'Upload Type';
$string['video_url'] = 'Video URL';
$string['change_status'] = 'Slide status';
$string['confirm_change_status0'] = 'Do You really want to hide this slide?';
$string['confirm_change_status1'] = 'Do You really want to unhide this slide?';
$string['change_status_noti1'] = 'your slide successfully hide.';
$string['change_status_noti0'] = 'your slide successfully unhide.';
$string['play_video'] = 'Play Video';
$string['hide'] = 'Hide Slide';
$string['show'] = 'Unhide Slide';

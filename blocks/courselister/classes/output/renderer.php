...
final class renderer extends plugin_renderer_base {
     ...
     */
    public function get_featured_courses($filter = false) {
        $systemcontext = \context_system::instance();
        $options = array('targetID' => 'myselectedcourses','perPage' => 3, 'cardClass' => 'col-xl-4 col-md-6 col-12', 'viewType' => 'card');
        ...
        if($filter){
            ...
            return  $this->render_from_template('block_courselister/block_courselister', $systemcontext);
        }
